...
SUBROUTINE get_result(output_for_python)

real(kind=8), dimension(n_out), intent(out) :: output_for_python
integer :: i
...
subroutine test(n, vals, n_params, which, ord)
