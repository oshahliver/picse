...
c_list = [[4215.3, -2.2584, 3.2069e-2], #liquid
          [2100, 0, 0], #ice Ih
          [2500, 0, 0], #ice III
          [2500, 0, 0], #ice V
          [2600, 0, 0]] #ice VI
...
Pref_list = [.1, 6.11657e-4, 355., 618.4, 2216.]
Tref_list = [180., 273.16, 256.43, 272.73, 356.15]

aT_list = [[1., 0., 2.963e-9, 3.17],
           [1., -1.0e-4, -5.0e-7, 2.],
           [1., -9.95e-5, -1.02e-6, 2.],
           [1., -8.33e-5, -4.95e-6, 2.],
           [1., -1.8e-4, 3.82e-8, 2.]]

aP_list = [[.7518, -3.07e-5, -3.6e-19, 5.2],
           [1., -9.84e-5, -2.146e-7, 2.],
           [1., -2.43e-4, -5.26e-7, 2.],
           [1., -2.07e-5, 2.42e-8, 2.],
           [1., 0., 0., 2.]]

P0_list = [2500., 6.11657e-4, 355., 618.4, 2216.]
...
def cp(T=None, P=None, ph=0):
    ...
    integral = aP1*(P-Pref)+.5*aP2*(P-Pref)**2+1./(aP4+1.)*(P-Pref)**(aP4+1.)
