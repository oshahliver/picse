...
Si_earth = [.47, .56] #Allowed range for bulk composition from Sotin et al. 2007
Mg_earth = [.47, .53] #Allowed range for bulk composition from Sotin et al. 2007
SFe_earth = [.081, 0.12]
SFe_solar = [.2, .3]
SFe_poor = [0., .0]
...
temperature_jumps=[0., 800., 300., 1200.]
...
names_solar = ['Mercury', 'Venus', 'Earth', 'Moon', 'Mars', 'Jupiter', 'Europa',
               'Io', 'Ganymede', 'Saturn', 'Enceladus', 'Titan', 'Uranus', 
               'Neptune', 'Pluto']

abbrevations_solar = ['M', 'V', 'E', 'm', 'M', 'J', 'e', 'i', 'g', 'S', 'e', 't', 
                      'U', 'N', 'P']

M_solar = [0.0553, 0.815, 1., 0.0123, 0.107, 317.83, 0.008035, 0.015, 0.0248, 
           95.159, 0.000018, 0.0225, 14.536, 17.147, 0.002]

R_solar = [0.3829, 0.9499, 1., 0.2727, 0.532, 10.97, 0.245, 0.2859, 0.4135, 9.14, \
           0.0395, 0.4037, 3.981, 3.865, 0.186]


MoI_solar = [.346, None, .3307, .3929, .3662, .2756, .346, .37824, .3115,
             .22, .3305, .341, .23, .23]

delta_MoI_solar = [.014, None, 0., .0009, .0017, .0006, .005, .00022, .0028, 
                   None, .0025, None, None, None]    
...
M_trappist1 = [1.02, 1.16, 0.3, .77, .93, 1.15, .33]
R_trappist1 = [1.12, 1.1, 0.78, .92, 1.05, 1.15, .77]
M_trappist1_error = [0.15, 0.14, 0.04, 0.08, 0.08, 0.1, 0.06]
R_trappist1_error = [0.03, 0.03, 0.02, 0.03, 0.03, 0.03, 0.03]
names_trappist1 = ['b', 'c', 'd', 'e',
                   'f', 'g', 'h']

#values in jovian units
names_others = ['K-011 b', 'K-011 c', 'K-029 c', 
                'K-048 b', 'K-060 c',
                'K-097 b', 'K-098 b', 'K-099 b',
                'K-102 d', 'K-114 c',
                'K-138 c', 'K-138 d', 'K-128 b']

M_others = [0.006, 0.009, 0.01259, 0.0124, 0.01211,
            0.011, 0.011, 0.019,
            0.012, 0.009, 0.0062, 0.002014, 0.0023]
R_others = [0.161, 0.256, 0.28, 0.168, 0.17,
            0.132, 0.178, 0.132, 0.105,
            0.143, 0.107, 0.1081, 0.128]
M_others_error = [(0.004, 0.003), (0.009, 0.005), (0.00387, 0.00406), 
                  (0.00661, 0.00661), (0.00255, 0.00255),
                  (0.006, 0.006), (0.005, 0.005),
                  (0.004, 0.004), (0.006, 0.006),
                  (0.002, 0.002), (0.00602, 0.00352), (0.002121,0.001218),
                  (.00151, .00079)]
R_others_error = [(0.003, 0.004), (0.004, 0.005), (0.018, 0.018), (0.009, 0.009), 
                  (0.013, 0.013), 
                  (0.012, 0.012), (0.02, 0.02), 
                  (0.007, 0.007),
                  (0.004, 0.004), (0.016, 0.016), (0.006, 0.006),
                  (0.0067, 0.0067), (.008, .008)]
...
gas_material_plot_list = [r'$\rm H$', r'$\rm He$', r'$\rm O_2$', r'$ \rm H_20$', r'$\rm N$']

#molar mass in kg for each substance
molar_mass_list = [mH*2+mO, 
                   mMg*2+mSi+mO*4, 
                   mMg*2+mSi*2+mO*6, 
                   mFe*2+mSi+mO*4,
                   mFe*2+mSi*2+mO*6, 
...
T0_list = [300.,300.,300.,300.,300.,300.,300.,300., 300.,300.,300., 300, 300.,
           300., 300., 300., 300., 300., 300., 300., 300.]
aT_list = [0., 2.832e-5, 2.86e-5, 2.832e-5, 2.86e-5, None, 2.302e-5, None, None, 
           None, None, 7.3e-5, 2.832e-5, 2.832e-5, 2.832e-5, 2.406e-5, None, 
           None, None, None, None]
bT_list = [0., 7.58e-9, 7.2e-9, 7.58e-9, 7.2e-9, None, 9.441e-9, None, None, None,
           None, 3.6e-8, 7.58e-9, 7.58e-9, 7.58e-9, 1.034e-8, None, None, None,
           None, None]
cT_list = [.0, .0, .0, .0, 0., None, 0.0, None, None, None, None, 0., 0., 0., 
           0., 0., None, None, None, None, None]
aP_list = [None, -.016e9, 0., -.016e9, 0., None, -0.04e9, None, None, None, None,
           -.011e9, -.016e9, -.016e9, -.016e9, -0.033e9, None, None, None, None,
           None]
...
#phases
phase_list_Mg2SiO4 = ['alpha', 
                      'beta', 
                      'gamma']

K0prime_list_Mg2SiO4 = [4.3, 
                        4.6, 
                        5.3]

aP_list_Mg2SiO4 = [-.016e9,
                   -.018e9,
                   -.021e9]

#From Ye et al 2009
aT_list_Mg2SiO4 = [2.19e-5,
                   1.6e-5,
                   2.54e-5]

#From Ye et al 2009
bT_list_Mg2SiO4 = [2.4e-8,
                   2.2e-8,
                   1.22e-8]
...
daTdH2O_list_Mg2SiO4 = [-4.6e-6,
                        -6.7e-6,
                        -9.7e-6]

dbTdH2O_list_Mg2SiO4 = [0.9e-8*.5,
                        2.5e-8*.5,
                        2.6e-8*.5]
...
rho0_coeffs_Mg2SiO4 = [[3.222e3, 0.012e3, -0.049e3],
...
K0_coeffs_Mg2SiO4 = [[128.0e9, 0.1e9, -3.8e9, -0.4e9],
...
G0_coeffs_Mg2SiO4 = [[81.6, -.3, -2.2, -.52],
                     [114., -.8, -9.7, .5],
                     [120.4, -.1, -5.6, -.9]]
...
delta_rho_MgO_coeffs = [1.3283, -2.8464e-1, 2.66913e-2, -9.2556e-4, 4.8976e-4,
                        -1.9528e-4, 2.9641e-05, -1.4748e-06, -1.9716]
...
dK0prime_pv = 0.
dd0_pv = 31. #use linear scaling from Sinmyo 2014 table 2 (at 26 GPa, 2073 K)
...
dK0_ppv = (255.0e9-205.4e9)/9.
dK0prime_ppv = (5.069-3.7)/9.
...
thetaD0_list = [None, #H2O
                None, #Mg2SiO4
                None, #Mg2Si2O6
                None, #Fe2SiO4
                None, #Fe2Si2O6
                599/.775, #MgO Dorogokupets 2010
                950, #MgSiO3, Wolf 2015
                430., #FeO Alibert 2014
                1017., #FeSiO3
                227., #Fe, Belonoshko 2010
                998., #FeS Alibert 2014
                1470., #Mg(OH)2
                None, 
                None, 
                None,
                995., #post-MgSiO3, Sun 2018
                1109., #SiO2 Stv, Fischer 2018
                1109., #CaCl2-type Silica, Fischer 2018
                417., #FeSi Fischer 2014
                227., #epsilon-Fe (hcp), Belonoshko 2010
                314., #Fe3C (fcc), Takahashi 2019
                ]
...
q_list = [None, 
          ...
          1., #SiO2 Stv, Fischer 2018
          1., #CaCl2-type Silica, Fischer 2018
          1.7, #FeSi Fischer 2014
          .489, #epsilon-Fe (hcp), Belonoshko 2010
...
rho0_list_Brucite = [2323., 2544., rho0_list[5]]
...
Margules_FeO_Fe = [[83307., 8.978, .09], [135943., 31.122, .059]]
