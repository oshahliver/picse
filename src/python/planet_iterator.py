    ...
    def iterate(self, planet=None, what=['M_surface'], how=['P_center'],
        ...
        for i in range(len(what)):
            ...
            if w == 'M_surface' or w == 'M_ocean':
                ...
                planet.initials[w+'_should'] = val_should[i] / (G * m_earth**2 / r_earth * 3/5)

            elif w == 'L_int':
                planet.initials[w+'_should'] = val_should[i] / (4 * np.pi * r_earth**2 * sigmaSB * 300**4)
        ...
        for p in range(2**(len(how))-1):
            ...
            for i in range(len(what)):
                ...
                what[i] == 'M_surface' or what[i] == 'M_ocean' or what[i] == \
                    'ocean_frac' or what[i] == 'E_tot' or what[i] == 'L_int':
                ...
                if how[i] == 'M_core':
                    ...
                    planet.initials['layermasses'][1] = newval[i]# * (1. - planet.initials['inner_core_frac'])
        ...
        while self.iteration:
            ...
            '''
            print ('oldwhatvals =', self.oldwhatvals)
            linsys = mgen.LinearSystem(self.oldwhatvals[-2**len(how):],
