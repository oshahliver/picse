...
for k in range(len(masses)):
    ...
    for i in range(len(temps)):
        ...
        for j in range(len(Mg_numbers)):
            ...
            pl1 = toolkit.model_hydro(P_center=9.5e10, 
                                       match_mass=True, 
                                       eps_r=0.25, 
                                       predictor_T='none', 
                                       ocean=False, 
            ...
            pl2 = toolkit.model_hydro(P_center=9.5e10, 
                                       match_mass=True, 
                                       eps_r=0.25, 
                                       predictor_T='none', 
                                       ocean=False, 
            ...
            pl3 = toolkit.model_hydro(P_center=9.5e10, 
                                       match_mass=True, 
                                       eps_r=0.25, 
                                       predictor_T='none', 
                                       ocean=True, 
